...
class StatusInfo(_Base, _GetRawBase):
...
class _DictStatusInfo(_Base, _GetDictBase):
...
class _NonMutableDictStatusInfo(_Base, _GetDictBase):
    pass

# =============================================================================


#class _MutableStatusInfoBase(_StatusInfoBase)
#
